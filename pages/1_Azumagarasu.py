...
#   st.table(df)
  ...
  st.write("それは、ざっと見る限り、100ページ以上のかなりくせのある崩し字で書かれた日記のような古文書で、芭蕉など著名な俳人のことや\
  自作の俳句などが書かれているようだった。")
  st.write("りゅうじえもんによると、以前、りゅうじえもんの家の古文書目録作成のために市が調査した際は、「雑記録（メモ帳）」として位置づけられたとのことだ。\
  「東烏」という俳号が頻出するため、おそらくこれがこの日記の書き手の俳号だと推測された。")
  st.write("（しかし、このくせ字を読み解くのは、少々難儀だな）")
  st.write("そう思いながら画像の最後の方まで見たさとる部長の目に、一つの文章が飛び込んできた。")
  st.image("pic/wakamekago.jpg")
  st.subheader("「和歌芽籠草稿完」")
  st.write("そうか、東烏はこの本を和歌の本として、世に出したかったのだ。")
  st.write("今は雑記帳として埋もれてしまっている、この本を読んでくれ。東烏がそう自分に言ってきている気がした。")
  st.write("さとる部長は、一心不乱に翻刻作業を開始した。")
