...
if selector=="はじめに":
  ...
  st.header("残された点帖")
  st.write('当初、これが一体何のかが皆目見当がつかなかったため、さとる部長と専門の先生にご相談した結果、句会の「点帖」であることが分かった。')
  st.write('点帖とは句会の記録であり、「執筆」が書いたものを「点者」「宗匠」が批点・押印、最終的には、秀逸の者の褒美として贈られるものである。')
  
  st.write('家にこの点帖が残されていたということは、俳号「玄」が当家にまつわる人間である可能性が高まった。東烏に加え、「玄」も調査対象に加わることとなった。\
  ...
  st.write("あわせて、専門家の先生により、その句会の点者が、尾張・三河では著名の「竹内（大鶴庵）塊翁」であることが分かった。名のある点者の句会へ参加し、\
